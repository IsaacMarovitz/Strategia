        ...
        public void SetPosition(GraphyManager.ModulePosition newModulePosition) {
            ...
            switch (newModulePosition) {
                ...
                case GraphyManager.ModulePosition.BOTTOM_LEFT:
                    ...
                    m_processorTypeText.alignment = GetTmpAlignment(TextAnchor.UpperLeft);
                    m_systemMemoryText.alignment = GetTmpAlignment(TextAnchor.UpperLeft);
                    m_graphicsDeviceNameText.alignment = GetTmpAlignment(TextAnchor.UpperLeft);
                    m_graphicsDeviceVersionText.alignment = GetTmpAlignment(TextAnchor.UpperLeft);
                    m_graphicsMemorySizeText.alignment = GetTmpAlignment(TextAnchor.UpperLeft);
                    m_screenResolutionText.alignment = GetTmpAlignment(TextAnchor.UpperLeft);
                    m_gameWindowResolutionText.alignment = GetTmpAlignment(TextAnchor.UpperLeft);
                    m_operatingSystemText.alignment = GetTmpAlignment(TextAnchor.UpperLeft);
                ...
                case GraphyManager.ModulePosition.BOTTOM_RIGHT:
                    ...
                    m_processorTypeText.alignment = GetTmpAlignment(TextAnchor.UpperRight);
                    m_systemMemoryText.alignment = GetTmpAlignment(TextAnchor.UpperRight);
                    m_graphicsDeviceNameText.alignment = GetTmpAlignment(TextAnchor.UpperRight);
                    m_graphicsDeviceVersionText.alignment = GetTmpAlignment(TextAnchor.UpperRight);
                    m_graphicsMemorySizeText.alignment = GetTmpAlignment(TextAnchor.UpperRight);
                    m_screenResolutionText.alignment = GetTmpAlignment(TextAnchor.UpperRight);
                    m_gameWindowResolutionText.alignment = GetTmpAlignment(TextAnchor.UpperRight);
                    m_operatingSystemText.alignment = GetTmpAlignment(TextAnchor.UpperRight);
